...
4. Отдельно опиши, почему ты считаешь обнаруженный дефект именно багом, а не фичами или ожидаемым поведением. 
5. Опиши гипотезу о возможных причинах возникновения дефекта и точках исправления (техническое размышление).
6. Подумай более комплексно: проанализируй влияние дефекта на пользователя и бизнес-процессы: отдельно опиши, какие риски и неудобства он вызывает.
7. Выполненное задание оформи в документе *task\_3.md.*
...
2. Представь, что в процессе жизненного цикла баг-репорта возникает несколько конфликтных сценариев: 
