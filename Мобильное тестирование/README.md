...
2. Составь чек-лист "внешних прерывателей" (не менее 10 пунктов), который команда будет использовать при тестировании. Чек-лист должен покрывать максимум типов внешних прерывателей. 

Для 3-х наиболее критичных для финансового приложения прерываний предложи сценарий тестирования.

3. Изучи тему утечки памяти в  в контексте работы мобильного приложения.
...
4. Ответь на вопрос: «Что такое утечка памяти в контексте работы мобильного приложения?»

5. Все созданные материалы (таблица, чек-лист, рекомендации и сообщения) оформи  в документе `task_1.md`.
...
1. Создай эмулятор с поддержкой Play Market в Android Studio (остальная конфигурация любая). Сделай скриншот успешно запущенного эмулятора.
1. Изучи процесс включения режима разработчика для своего мобильного телефона (для Android). Если нет физического устройства на Android — выполни на эмуляторе. Сделай скриншот раздела "Для разработчиков", демонстрирующий включенный режим. 
1. Изучи функцию Logcat в Android Studio и попрактикуйся в снятии логов. Сделай скриншот этой записи.
1. Изучи гайды по созданию симулятора в Xcode. Напиши краткую пошаговую инструкцию "для коллеги", который никогда этого не делал. В инструкции укажи не только шаги, но и на что важно обращать внимание.
1. Созданные материалы и скриншоты, отражающие процесс работы, положи в документ `task_3.md`.
...
3. Напиши драфт баг-репорта для этой проблемы, вложив в описание пример логов, которые, по твоему мнению, помогут разработчику понять причину проблемы.
4. Ответы на пункты задания и баг-репорт оформи в документе `task_4.md`.
...
4. Выполненное задание (название интернет-магазина, ссылки на скринкасты и описание изменения поведения сайта) оформи в документе `task_5.md`.
